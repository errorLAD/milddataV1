...
SAAS_PRODUCTS = {
    ...
    "fieldsaas": {
        "slug": "fieldsaas",
        "name": "FieldSaaS — Field Service Management",
        "folder_name": "fieldsaas",
        "project_name": "fieldsaas_proj",
        "category": "Field Operations & Services",
        "category_code": "saas_tool",
        "developer": "Milda Data",
        "launch_date": "March 2025",
        "support_info": "Email, Chat, Ticket",
        "description": "Real-time field service dispatch, technician scheduling, job tracking, estimates, customer leads pipeline, and mobile PWA.",
        "short_description": "Streamline technician dispatches, track job statuses, manage customer estimates, and optimize field service operations.",
        "status": "active",
        "price_inr_monthly": 199.00,
        "price_inr_yearly": 1982.00,
        "price_usd_monthly": 5.00,
        "price_usd_yearly": 49.80,
        "env_var": "FIELDSAAS_APP_URL",
        "default_url": "http://localhost:8008",
        "app_route": "/",
        "login_route": "/login/",
        "guest_route": "/guest-login/",
        "features": [
            {"title": "Operations & Dispatch Dashboard", "desc": "Real-time operational summary of field service dispatch, revenue, and active jobs."},
            {"title": "Leads & Prospects Pipeline", "desc": "Track sales inquiries, customer leads, and convert them to jobs and estimates."},
            {"title": "Technicians & Field Crew Roster", "desc": "Manage field service personnel, roles, contact info, and job assignments."},
            {"title": "Estimates & Quotes Management", "desc": "Create quotes, get client approvals, and convert them directly into active jobs or invoices."},
            {"title": "Technician Mobile PWA", "desc": "Mobile-ready app for field technicians to view assigned jobs and update job statuses."},
            {"title": "Invoices & Revenue Tracking", "desc": "Issue GST invoices for completed jobs, track unpaid balances, and manage payment receipts."},
        ],
        "benefits": [
            "Optimize technician scheduling and reduce travel response times",
            "Convert leads to jobs automatically with instant estimates",
            "Real-time mobile PWA access for field service technicians",
            "Eliminate manual paperwork with digital invoices and customer sign-offs",
        ],
    },
    "maithili-voice-ai": {
        "slug": "maithili-voice-ai",
        "name": "Maithili & Indic Voice AI Agent",
        "folder_name": "mithila_ai",
        "project_name": "mithila_ai",
        "category": "AI Agent",
        "category_code": "ai_agent",
        "developer": "Milda Data",
        "launch_date": "February 2025",
        "support_info": "Email, Chat, Ticket",
        "description": "Specialized Indic speech-to-text, dialect recognition, and conversational voice AI agent for Maithili, Hindi, and Bhojpuri regional workflows.",
        "short_description": "Trilingual Indic voice AI agent for Maithili & regional language speech transcription and customer automation.",
        "status": "active",
        "price_inr_monthly": 199.00,
        "price_inr_yearly": 1982.00,
        "price_usd_monthly": 5.00,
        "price_usd_yearly": 49.80,
        "env_var": "MAITHILI_VOICE_AI_URL",
        "default_url": "http://localhost:8000",
        "app_route": "/mithila-ai/",
        "login_route": "/mithila-ai/",
        "guest_route": "/mithila-ai/",
        "features": [
            {"title": "Maithili Dialect Recognition", "desc": "High-precision speech recognition trained on regional Indic audio datasets."},
            {"title": "Trilingual Speech Synthesis", "desc": "Natural text-to-speech rendering in Maithili, Hindi, and English."},
            {"title": "Conversational Dialogue Agent", "desc": "Context-aware conversational agent for customer support and field logs."},
            {"title": "API & Webhook Integrations", "desc": "REST API endpoints for real-time speech transcription and audio parsing."},
        ],
        "dashboard_stats": {
            "stat1_label": "Dialects Supported", "stat1_val": "3",
            "stat2_label": "Transcription Accuracy", "stat2_val": "96.8%",
            "stat3_label": "Audio Models", "stat3_val": "4",
            "stat4_label": "Latency", "stat4_val": "340ms",
        },
        "benefits": [
            "Empower regional language users with natural voice interfaces",
            "Automate customer service in native Maithili and Hindi dialects",
            "Seamless web API integration for enterprise mobile apps",
        ],
    },
    "indic-ocr-agent": {
        "slug": "indic-ocr-agent",
        "name": "Indic Document & Invoice OCR Agent",
        "folder_name": "mithila_ai",
        "project_name": "mithila_ai",
        "category": "AI Agent",
        "category_code": "ai_agent",
        ...
        "launch_date": "March 2025",
        "support_info": "Email, Chat, Ticket",
        "description": "AI vision agent for automated regional invoice OCR, handwritten Devanagari script recognition, and document data extraction.",
        "short_description": "Automated AI document vision agent for parsing regional B2B invoices and handwritten bills into structured JSON data.",
        "status": "active",
        "price_inr_monthly": 199.00,
        "price_inr_yearly": 1982.00,
        "price_usd_monthly": 5.00,
        "price_usd_yearly": 49.80,
        "env_var": "INDIC_OCR_AGENT_URL",
        "default_url": "http://localhost:8000",
        "app_route": "/mithila-ai/",
        "login_route": "/mithila-ai/",
        "guest_route": "/mithila-ai/",
        "features": [
            {"title": "Devanagari OCR Extraction", "desc": "Extract printed and handwritten text in Hindi, Maithili, and English."},
            {"title": "Automated Line-Item Breakdown", "desc": "Parse GSTIN numbers, tax amounts, line items, and invoice subtotals automatically."},
            {"title": "Multi-Format File Support", "desc": "Accept PDF documents, mobile camera scans, PNG, and JPEG images."},
        ],
        "dashboard_stats": {
            "stat1_label": "OCR Accuracy", "stat1_val": "98.2%",
            "stat2_label": "Processing Speed", "stat2_val": "1.2s",
            "stat3_label": "Languages", "stat3_val": "Indic + EN",
            "stat4_label": "Extracted Fields", "stat4_val": "24",
        },
        "benefits": [
            "Eliminate manual data entry for incoming vendor bills and receipts",
            "High accuracy Devanagari handwritten script recognition",
            "Direct ERP ledger export capabilities",
        ],
    },
    "collections-ai-agent": {
        "slug": "collections-ai-agent",
        "name": "Smart Collections & AR Recovery AI Agent",
        "folder_name": "b2bpayment",
        "project_name": "udhaar_crm",
        "category": "AI Agent",
        "category_code": "ai_agent",
        ...
        "launch_date": "March 2025",
        "support_info": "Email, Chat, Ticket",
        "description": "Autonomous AI voice & WhatsApp agent for automated B2B collection calls, overdue account prioritization, and promise-to-pay tracking.",
        "short_description": "Autonomous AI voice and WhatsApp collections agent for automated payment recovery and customer risk scoring.",
        "status": "active",
        "price_inr_monthly": 199.00,
        "price_inr_yearly": 1982.00,
        "price_usd_monthly": 5.00,
        "price_usd_yearly": 49.80,
        "env_var": "COLLECTIONS_AI_URL",
        "default_url": "http://localhost:8001",
        "app_route": "/",
        "login_route": "/accounts/login/",
        "guest_route": "/accounts/guest-login/",
        "features": [
            {"title": "AI Risk Scoring Engine", "desc": "Predict customer payment defaults and rank overdue accounts by recovery urgency."},
            {"title": "WhatsApp Recovery Workflow", "desc": "Draft personalized multi-channel reminders and track customer responses."},
            {"title": "Promise-to-Pay Ledger", "desc": "Log customer payment commitments automatically with automated follow-ups."},
        ],
        "dashboard_stats": {
            "stat1_label": "Recovery Boost", "stat1_val": "+38%",
            "stat2_label": "AI Risk Accuracy", "stat2_val": "95.4%",
            "stat3_label": "Automated Cadence", "stat3_val": "Active",
            "stat4_label": "Time Saved", "stat4_val": "15 hrs/wk",
        },
        "benefits": [
            "Recover overdue customer balances 3x faster with AI risk scoring",
            "Automated WhatsApp reminder drafting tailored per customer",
            "Seamless integration with B2B Payment Reminder OS",
        ],
    },
}
